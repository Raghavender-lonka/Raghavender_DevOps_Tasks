...
- Redis Cluster is up and running.

![alt text](references/image-2.png)

- Injecting some data into the cluster.

## Python Script

We need the following python modules for our data extraction script
...
### Output of our python script

![alt text](references/image-3.png)

## Deploying python script to managed cloud environment (lambda function)
